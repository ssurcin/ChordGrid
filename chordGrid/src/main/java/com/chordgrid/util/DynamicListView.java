...
public class DynamicListView extends ListView {
    ...
    public ArrayList<? extends Object> mItemsList;
    ...
    private OnItemLongClickListener mOnItemLongClickListener =
            new OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    Log.v(TAG, String.format("Long click on item %d \"%s\"", itemNum, getAdapter().getItem(itemNum).toString()));
    ...
    public void setItemsList(ArrayList<? extends Object> items) {
        mItemsList = items;
    }
}